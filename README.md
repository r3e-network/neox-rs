...
| Component | Baseline |
|---|---|
| Reth | `3bc71d43f7101f772bbb4f9e15d3cdd58f60e958` (`2.5.1`); upstream tip under review: `0b3475a83e0712beb3d1f639ea467c55c5117412` |
...
curl -fsSL https://raw.githubusercontent.com/r3e-network/neox-rs/neox/scripts/install.sh \
  | bash -s -- --version neox-v2.5.0 --install-dir "$HOME/.local/bin" --no-modify-path
```
