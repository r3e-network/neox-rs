...
主要开放项：TPKE commitment 绑定的跨实现向量、Beacon/dbft 混合互通、DKG epoch/recovery 活体验证、Reth 最新 tip 的独立同步演练。Neo X 全量 crate 测试已在正确的 MSVC 环境通过；仍需双节点活体验证才能宣称 Geth 混合网络 100% 一致。
